...
func ResourceNotFoundException(resoureName string, fieldName string, fieldValue string) error{
	msg := fmt.Sprintf("%s not found with %s : %s", resoureName,fieldName,fieldValue)
